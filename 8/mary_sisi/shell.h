...
calls fgets to get user input

In the infinite loop, an array of strings (char ** args) is allocated to hold user input (see parse() below) and handle said user input (see execute() below).  
 */
...
/*
returns the number of times char c is in string s
*/
